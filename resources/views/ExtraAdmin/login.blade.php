...
<form method="post" action="{{ url('/admin/check_login') }}" id="loginVlidation">
{{ csrf_field() }}
<label>Email:</label>
<input name="email" type="text" class="form-control" id="email" value="@php if(!isset($_COOKIE['email'])){ echo old('email'); }else{ echo $email; } @endphp"> 
<br><br>
...
<div class="form-group">
   	<!--<label>Keep me signed in</label>-->
    <a href="changepassword.blade.php">Change_password</a>
    </div>
