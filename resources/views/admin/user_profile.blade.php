...
<form action="/search_user" method="get" class="app-search d-none d-md-block me-3">

                            
    <input type="text" name="search_user" class="form-control mt-0" placeholder="Search here" value={{ request()->query('search_user') }}><br>
