...
@section('content')
<form method="post" action="{{ url('/update_userData') }}" id="form1" enctype="multipart/form-data">
...
<input name="first_name" type="text" class="form-control" id="first_name" value="{{ $user->first_name }}"  placeholder="First Name"> 
<br>
<label>Last Name:</label>
<input name="last_name" type="text" class="form-control" id="last_name" value="{{ $user->last_name }}"  placeholder="Last Name"> 
<br>
<label>Email:</label>
...
<input name="mobile_no" type="text" class="form-control" id="mobile_no" value="{{ $user->mobile_no }}"  placeholder="Address">
<br>
...
<label> Birthdate:</label> 
    <input class="date form-control" name="birthdate" type="text" value="{{ $user->birthdate }}" placeholder="Birthdate">
...
<input name="address" value="{{ $user->address }}" class="form-control"  placeholder="Address"></input> <br>
...
<label>Pincode:</label>
 <input name="pincode" type="text" class="form-control" id="pincode" value="{{ $user->pincode }}"  placeholder="Pincode">
